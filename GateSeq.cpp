    ...
    if (enc <= 3 ) {
      ...
      if (enc == 2) {
        ...
        switch (genre) {//プリセットの選択
          case 0:
            display.print(F("TECHNO"));//表示領域の都合上、6文字とする
            break;

          case 1:
            display.print(F("DUBTCN"));
            break;
      ...
      if (enc == 3) {//Fillinの選択
        ...
        switch (fillin) {
          case 0:
            display.print(F("FilIN:N"));
            break;

          case 1:
            display.print(F("FilIN:Y"));
            break;
        }
      }
      else {
